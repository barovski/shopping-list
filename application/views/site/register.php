...
<script src="<?php echo base_url();?>public/js/jquery-1.7.1.min.js" type="text/javascript"></script>
                    ...
                    <body>
                        ...
                        <div id="login">
                            ...
                            <div id="login_box">
                                <div id="title"><h1><a  href="<?php echo base_url().'login'?>">Login</a> <strong> or </strong> <a class="active" href="<?php echo base_url().'register'?>">Register</a></h1></div>
                                <div class="cont">
                                    <p class="error_name_pass"><?php if(isset($error_register))
                                    { echo $error_register;
                                    }   ?></p>
                                    <?php 
                                    $params=array('id'=>'login_form');
                                    
                                    echo form_open(base_url().'register',$params);?>
                                    <h4>User name </h4>
